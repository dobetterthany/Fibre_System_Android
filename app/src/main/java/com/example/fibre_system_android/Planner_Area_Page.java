...
//      initSearchWidget();
    ...
    private void getData() {
        itemsArrayList.add(new Recycler_item("LShape", 1400, 1000, R.drawable.small_square, true, true, true, ShowerRange.LSHAPE));
        itemsArrayList.add(new Recycler_item("LShape", 1200, 1000, R.drawable.small_square, true, true, true, ShowerRange.LSHAPE));
        itemsArrayList.add(new Recycler_item("LShape", 1200, 900, R.drawable.small_square, true, true, true, ShowerRange.LSHAPE));
        itemsArrayList.add(new Recycler_item("LShape", 1200, 800, R.drawable.small_square, true, true, true, ShowerRange.LSHAPE));
        itemsArrayList.add(new Recycler_item("Luxury Frameless", 1400, 1000, R.drawable.small_square, true, true, true, ShowerRange.LUXURY_FRAMELESS));
        itemsArrayList.add(new Recycler_item("Luxury Frameless", 1200, 1000, R.drawable.small_square, true, true, true, ShowerRange.LUXURY_FRAMELESS));
        ...
        itemsArrayList.add(new Recycler_item("Luxury Frameless", 1200, 800, R.drawable.small_square, true, true, true, ShowerRange.LUXURY_FRAMELESS));
        itemsArrayList.add(new Recycler_item("Eline Round", 1000, 1000, R.drawable.square, true, false, false, ShowerRange.ELS));
        itemsArrayList.add(new Recycler_item("Eline Round", 900, 900, R.drawable.square, true, false, false, ShowerRange.ELS));
        itemsArrayList.add(new Recycler_item("Squareline", 900, 900, R.drawable.square, true, false, false, ShowerRange.ELS));
        itemsArrayList.add(new Recycler_item("Squareline", 1000, 1000, R.drawable.square, true, false, false, ShowerRange.ELS));
        itemsArrayList.add(new Recycler_item("Square", 1000, 1000, R.drawable.large_square, true, true, true, ShowerRange.SQUARE));
